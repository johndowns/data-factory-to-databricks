...
-- Index on nameSid
CREATE NONCLUSTERED INDEX IX_fact_babynames_nameSid
ON [data].[fact_babynames] (nameSid);
GO

-- Index on yearSid
CREATE NONCLUSTERED INDEX IX_fact_babynames_yearSid
ON [data].[fact_babynames] (yearSid);
GO

-- Index on locationSid
CREATE NONCLUSTERED INDEX IX_fact_babynames_locationSid
ON [data].[fact_babynames] (locationSid);
GO
